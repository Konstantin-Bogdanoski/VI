...
class GraphProblem(Problem):
    ...
    def h(self, node):
        ...
        if locs:
            ...
            tempState = self.initial
            tempProb = GraphProblem(self.initial, self.goal, self.graph)
            tempAnswer = breadth_first_graph_search(tempProb)
            return tempAnswer.path_cost
...
if(rez1_cost <= rez2_cost):
    print(rez1Final)
else: print(rez2Final)
...
germanmap = UndirectedGraph(dict(
...
germanProblem = GraphProblem(Pocetok, Kraj, germanmap)
answer = astar_search(germanProblem)
